<template>
  ...
  >
    <aside class="w-auto">
      ...
      >
        ...
        <!-- K -->
        <path
          d="M55 10 H63 V30 L80 10 H90 L70 32 L90 50 H80 L63 34 V50 H55 Z"
        />

        <!-- WORLD (below baseline) -->
        <text
          x="55"
          y="68"
          font-size="14"
      ...
      <p class="text-secondary-content text-xs italic">
  ...
  >
    <aside>
      <p>
        Copyright © {{ new Date().getFullYear() }} - All right reserved by CK
        World
      </p>
    </aside>
  </footer>
